...
const VietnamPage = () => {
  ...
  const [priceRange, setPriceRange] = useState({ min: 48000, max: 110000 });
  const [sortBy, setSortBy] = useState('price-low');

  const sliderImages = [
    {
      src: "/destination/veitnamHero/veitnam1.jpg",
      title: "Ha Long Bay",
      subtitle: "Mystical limestone karsts rising from emerald waters"
    },
    {
      src: "/destination/veitnamHero/Veitnam2.jpg", 
      title: "Hoi An Ancient Town",
      subtitle: "Charming lantern-lit streets and traditional architecture"
    },
    {
      src: "/destination/veitnamHero/veitnam3.jpg",
      title: "Sapa Rice Terraces", 
      subtitle: "Breathtaking mountain landscapes and ethnic cultures"
    },
    {
      src: "/destination/veitnamHero/veitnam4.jpg",
      title: "Ho Chi Minh City",
      subtitle: "Vibrant metropolitan energy blending history and modernity"
    }
  ];
  ...
  const allPackages = [
    {
      image: "/destination/veitnamHero/veitnam1.jpg",
      ...
      type: "Classic",
      hotelRating: 4,
      features: ["4 Star Hotels", "Ha Long Cruise", "City Tours", "Local Cuisine"],
      highlights: "Ha Long Bay cruise • Cu Chi Tunnels • Hoi An lanterns • Mekong Delta"
    },
    {
      image: "/destination/veitnamHero/Veitnam2.jpg",
      ...
      type: "Cultural",
      hotelRating: 4,
      features: ["Heritage Sites", "Cultural Tours", "Local Experiences", "Traditional Shows"],
      highlights: "Imperial City • Ancient temples • Cooking classes • Lantern festival"
    },
    {
      image: "/destination/veitnamHero/veitnam3.jpg",
      ...
      type: "Quick",
      hotelRating: 3,
      features: ["Budget Hotels", "Ha Long Cruise", "Street Food", "City Walking"],
      highlights: "Old Quarter • Water puppets • Ha Long overnight • Local markets"
    },
    {
      image: "/destination/veitnamHero/veitnam4.jpg",
      days: "8 Nights 9 Days",
      title: "COMPLETE VIETNAM - North to South Journey",
      location: "Hanoi, Sapa, Ho Chi Minh",
      price: "₹95,000/-",
      type: "Complete",
      hotelRating: 4,
      features: ["Multi-City", "Mountain Trek", "Beach Time", "River Cruise"],
      highlights: "Sapa trekking • Hoi An cycling • Mekong cruise • Street food tours"
    },
    {
      image: "/destination/veitnamHero/veitnam1.jpg",
      days: "7 Nights 8 Days",
      title: "LUXURY VIETNAM - Premium Experience",
      location: "Premium Vietnam",
      price: "₹1,10,000/-",
      type: "Luxury",
      hotelRating: 5,
      features: ["5 Star Hotels", "Private Tours", "Fine Dining", "Luxury Cruise"],
      highlights: "Luxury junk cruise • Private guides • Michelin dining • Spa treatments"
    }
  ];
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-6xl md:text-8xl font-bold mb-6 drop-shadow-2xl">
              ...
              <br />
              <span className={limelight.className}>VIETNAM</span>
            </h1>
      ...
      <section id="packages-section" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Discover Your Perfect Vietnam Package</h2>
          ...
          <div className="flex gap-8">
            ...
            <div className="lg:w-1/4 bg-white rounded-lg p-6 h-fit shadow-lg">
              {(selectedPackageTypes.length > 0 || selectedHotelRatings.length > 0 || selectedDurations.length > 0 || priceRange.max < 110000) && (
                <div className="mb-6">
                  <button
                    onClick={() => {
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      style={{
                        background: `linear-gradient(to right, #fb923c 0%, #fb923c ${((priceRange.max - 48000) / (110000 - 48000)) * 100}%, #e5e7eb ${((priceRange.max - 48000) / (110000 - 48000)) * 100}%, #e5e7eb 100%)`
                      }}
                    />
                  </div>
