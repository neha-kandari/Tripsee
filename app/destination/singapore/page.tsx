...
const SingaporePage = () => {
  ...
  const sliderImages = [
    ...
    },
    {
      ...
      subtitle: "Tropical resort island with beaches, attractions, and entertainment"
    },
    {
      src: "/destination/singaporeHero/image4.jpg",
      title: "Clarke Quay",
      subtitle: "Vibrant riverside dining and nightlife in the heart of Singapore"
    }
  ];
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-6xl md:text-8xl font-bold mb-6 drop-shadow-2xl">
              ...
              <br />
              <span className={limelight.className}>SINGAPORE</span>
            </h1>
      ...
      <section id="packages-section" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Discover Your Perfect Singapore Package</h2>
                ...
                <div className="mb-6">
                  <button
                    onClick={() => {
                      ...
                      setPriceRange({ min: 55000, max: 120000 });
                      setSortBy('price-low');
                      setCurrentPackageIndex(0);
                    }}
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      style={{
                        background: `linear-gradient(to right, #fb923c 0%, #fb923c ${((priceRange.max - 55000) / (120000 - 55000)) * 100}%, #e5e7eb ${((priceRange.max - 55000) / (120000 - 55000)) * 100}%, #e5e7eb 100%)`
                      }}
                    />
                  </div>
