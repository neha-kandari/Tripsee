...
const MalaysiaPage = () => {
  ...
  const sliderImages = [
    {
      src: "/destination/MalaysiaHero/image1.jpg",
      title: "Kuala Lumpur",
      subtitle: "Modern skyline dominated by the iconic Petronas Twin Towers"
    },
    {
      src: "/destination/MalaysiaHero/image2.jpg", 
      title: "Langkawi Islands",
      subtitle: "Tropical paradise with pristine beaches and crystal-clear waters"
    },
    {
      src: "/destination/MalaysiaHero/image3.jpg",
      title: "Penang Heritage", 
      subtitle: "UNESCO World Heritage site with rich cultural diversity"
    },
    {
      src: "/destination/MalaysiaHero/image4.jpg",
      title: "Cameron Highlands",
      subtitle: "Cool mountain retreat with tea plantations and strawberry farms"
    }
  ];
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-6xl md:text-8xl font-bold mb-6 drop-shadow-2xl">
              ...
              <br />
              <span className={limelight.className}>MALAYSIA</span>
            </h1>
      ...
      <section id="packages-section" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Discover Your Perfect Malaysia Package</h2>
          ...
          <div className="flex gap-8">
            ...
            <div className="lg:w-1/4 bg-white rounded-lg p-6 h-fit shadow-lg">
              {(selectedPackageTypes.length > 0 || selectedHotelRatings.length > 0 || selectedDurations.length > 0 || priceRange.max < 105000) && (
                <div className="mb-6">
                  <button
                    onClick={() => {
                      ...
                      setPriceRange({ min: 42000, max: 105000 });
                      setSortBy('price-low');
                      setCurrentPackageIndex(0);
                    }}
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      style={{
                        background: `linear-gradient(to right, #fb923c 0%, #fb923c ${((priceRange.max - 42000) / (105000 - 42000)) * 100}%, #e5e7eb ${((priceRange.max - 42000) / (105000 - 42000)) * 100}%, #e5e7eb 100%)`
                      }}
                    />
                  </div>
