...
const Bali6NightPremium = () => {
  ...
  const hotels = [
    ...
    },
    {
      ...
      note: "5 Star Resort by iNi Vie Hospitality"
    }
  ];
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 bg-white rounded-lg p-6 shadow-lg max-h-screen overflow-y-auto">
              ...
              <div className="mb-6 pb-6 border-b">
                ...
                <p className="text-xl text-gray-600 mb-2">Bali 6 nights premium package</p>
                ...
                <div className="space-y-6">
                  {hotels.map((hotel, index) => (
                    <div key={index} className="bg-gray-50 p-4 rounded-lg">
                      ...
                      {hotel.note && (
                        <p className="text-blue-600 font-medium text-sm">{hotel.note}</p>
                      )}
                      <a 
                        href={hotel.link} 
                        target="_blank" 
