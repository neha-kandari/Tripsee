...
const BaliHoneymoonBestSeller = () => {
  ...
  const hotels = [
    ...
    },
    {
      ...
      location: "Ubud, Bali",
      link: "https://swanparadisebali.com/?gad_source=1&gbraid=0AAAAA-ZGWwQsw1lRXmJNt1FHKcL-BLLcb&gclid=Cj0KCQjwiLLABhCEARIsAJYS6ulbY67FjqcpKzaniIk6NXulgD1xr89IG-zbSrZsj7QlVpsDIZuWLscaAlyEEALw_wcB"
    }
  ];
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 bg-white rounded-lg p-6 shadow-lg max-h-screen overflow-y-auto">
              ...
              <div className="mb-6 pb-6 border-b">
                ...
                <p className="text-xl text-gray-600 mb-2">Bali 6 nights romantic getaway</p>
